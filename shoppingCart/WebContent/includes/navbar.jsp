...
<div class="container">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item"><a class="nav-link" href="cart.jsp">Cart<span class="badge badge-danger" px-2>${sessionCart_list.size() }</span></a></li>
     
	<%  if(auth!= null && auth.getRechte()== 4){    %>           															<!-- if user not logged in logout & orders visible-->
    	<li class="nav-item"><a class="nav-link disabled" href="checkUsers.jsp">CheckUsers</a></li>
    	<li class="nav-item"><a class="nav-link disabled" href="checkListings.jsp">ManageListings</a></li>      
